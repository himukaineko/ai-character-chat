...
export async function seedOnboardingData(): Promise<void> {
  ...
  const takeshi: Character = {
    ...
    appearance:
      "仕立ての良いダークスーツを着こなす、渋みのある大人の男性。がっしりとした体格で、まくった袖からは現場仕事で鍛えた腕がのぞく。無精髭はなく、きちんと整えられている。",
  ...
  const popo: Character = {
    ...
    background:
      "アプリの初期テスト中にシステム内部の余剰データから偶然生成された、愛くるしいモフモフの生き物。",
    occupation: "マスコットキャラ",
    ...
    appearance:
      "シマエナガのような、白くてまんまるのもふもふの姿。小さな翼とつぶらな瞳が愛らしく、羽毛の一部にほんのり淡い水色が差している。",
